...
# Part of this tool
foreach my $pn ("MMisc", "TrecVid08ViperFile", "TrecVid08EventList", "TrecVid08HelperFunctions") {
...
my $versionid = "TrecVid08 ViPER XML File Merger ($versionkey)";
...
It is possible to specify their location using the B<--xsdpath>.
