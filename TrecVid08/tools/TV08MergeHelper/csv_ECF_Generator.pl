...
#
# "TrecVid08 ECF Generator" is an experimental system.
...
my $versionid = "TrecVid08 ECF Generator (Version: $version)";
...
# Part of this tool
foreach my $pn ("ViperFramespan", "MMisc") {
