...
#
# "CLEARTRHelperFunctions.pm" is an experimental system.
...
my $VF_MemDump_FileHeader_cmp = "\#  CLEARTRViperFile MemDump";
...
my $SS_MemDump_FileHeader_cmp = "\#  CLEARTRScorinSequence MemDump";
...
sub _load_XML_ViperFile {
  ...
  # Prepare the object
  my $object = new CLEARTRViperFile($evaldomain);
...
sub _load_MemDump_ViperFile {
  ...
  return(0, undef, $rtxt . "Problem reading memory representation: Not a ViperFile MemDump") 
    if (ref $object ne "CLEARTRViperFile");
