$expid_count = 8;
@expid_tag  = ( 'MED16' ); # should only contain 1 entry
@expid_data = ( 'MED16DRYRUN', 'MED16EvalSub', 'MED16EvalFull' ); # <SEARCH> order is important
...
$db_check_sql = "TV16MED-SubmissionChecker_conf-DBcheck.sql";
