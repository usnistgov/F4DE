$expid_count = 8;
@expid_tag  = ( 'MED17' ); # should only contain 1 entry
@expid_data = ( 'MED17DRYRUN', 'MED17EvalFull' ); # <SEARCH> order is important
@expid_task = ( 'PS', 'AH' ); # <EVENTSET> order is important
@expid_traintype = ( '10Ex' ); # <EKTYPE> order is important
...
$db_check_sql = "TV17MED-SubmissionChecker_conf-DBcheck.sql";
