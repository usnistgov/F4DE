...
!!! Divide up these arg/values into sets to nake it simpler to userstand
- required 
  - input files - 
  - output 
...
Step 1. Scheme configuration generation

Step 2. SQL table creation and populating

Step 3. SQL Filtering

Step 4. Scoring with DETCurve generation
...
Describe scheme of ref, sys and metadat
Describe config files (and how they will be automatically generated by)
