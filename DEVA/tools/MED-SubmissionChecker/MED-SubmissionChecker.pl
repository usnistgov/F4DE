...
&__cfgcheck("\@expid_MEDtype", (scalar @expid_MEDtype == 0), ($medyear ne 'MED13' && $medyear ne 'MED15' && $medyear ne 'MED16'));
&__cfgcheck("\@expid_traintype", (scalar @expid_traintype == 0), (($expid_count == 9) || ($medyear eq 'MED13')));
&__cfgcheck("\@expid_EAG", (scalar @expid_EAG == 0), ($medyear ne 'MED13' && $medyear ne 'MED15' && $medyear ne 'MED16'));
&__cfgcheck("\@expid_sysid_beg", (scalar @expid_sysid_beg == 0), ($medyear ne 'MED13' && $medyear ne 'MED15' && $medyear ne 'MED16'));
...
foreach my $sf (@ARGV) {
  ...
  if (! defined $wid) {
    ...
    if ($medyear eq 'MED13' || $medyear eq 'MED15' || $medyear eq 'MED16') {
...
sub check_archive_name {
  ...
  return(check_archive_name13p($file)) if ($medyear eq 'MED13' || $medyear eq 'MED15' || $medyear eq 'MED16');
